        ...
        <>
            <footer className="bg-cyan-600 text-white">
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-3 mt-56 border-b border-gray-300 py-4 mx-4">
                        <div className="p-4">
                            <h3 className="text-3xl text-white font-bold mt-14">Event Webinar</h3>
                        </div>
